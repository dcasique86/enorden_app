...
class DatabaseManager:
    ...
    def crear_movimiento(self, cliente_id: str, tipo: str, descripcion: str, monto: float) -> Dict[str, Any]:
        ...
        try:
            cursor = conn.cursor()
            cursor.execute(
                "INSERT INTO movimientos (id, cliente_id, tipo, descripcion, monto, fecha, timestamp) VALUES (?, ?, ?, ?, ?, ?, ?)",
